...
function  calculateAge(y, f) {
    switch (true) {
        case (f > y) && f - y !== 1: return `You are ${f-y} years old.`
        case (f > y): return `You are 1 year old.`
        case (y > f && y - f !== 1): return `You will be born in ${y-f} years.`
        case (y > f): return `You will be born in 1 year.`
        default: return 'You were born this very year!'
    }
}
